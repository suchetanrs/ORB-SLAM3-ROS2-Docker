...
bool slam_msgs__msg__map_graph__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("slam_msgs.msg._map_graph.MapGraph", full_classname_dest, 33) == 0);
  }
  slam_msgs__msg__MapGraph * ros_message = _ros_message;
  {  // header
  ...
  {  // poses_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "poses_id");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->poses_id.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'poses_id'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MapGraph */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("slam_msgs.msg._map_graph");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MapGraph");
  ...
  {  // poses_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "poses_id");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->poses_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->poses_id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->poses_id.size * sizeof(int32_t));
      assert(data != NULL);
