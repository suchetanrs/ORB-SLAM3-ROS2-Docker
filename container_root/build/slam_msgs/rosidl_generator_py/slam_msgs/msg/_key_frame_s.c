...
bool slam_msgs__msg__key_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("slam_msgs.msg._key_frame.KeyFrame", full_classname_dest, 33) == 0);
  }
  slam_msgs__msg__KeyFrame * ros_message = _ros_message;
  {  // id
  ...
  {  // word_pts
    ...
    geometry_msgs__msg__Point * dest = ros_message->word_pts.data;
...
{
  /* NOTE(esteve): Call constructor of KeyFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("slam_msgs.msg._key_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyFrame");
