...
#include "slam_msgs/msg/detail/map_data__rosidl_typesupport_fastrtps_c.h"
...
#include "slam_msgs/msg/detail/key_frame__functions.h"  // nodes
#include "slam_msgs/msg/detail/map_graph__functions.h"  // graph
...
size_t get_serialized_size_slam_msgs__msg__MapGraph(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_slam_msgs__msg__MapGraph(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, msg, MapGraph)();
...
using _MapData__ros_msg_type = slam_msgs__msg__MapData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: graph
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, slam_msgs, msg, MapGraph
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->graph, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, slam_msgs, msg, KeyFrame
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      slam_msgs__msg__KeyFrame__Sequence__fini(&ros_message->nodes);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_slam_msgs__msg__MapGraph(
  ...
  // field.name nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_slam_msgs__msg__KeyFrame(
...
static uint32_t _MapData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_slam_msgs__msg__MapData(
  ...
  size_t current_alignment)
{
  ...
  // member: graph
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_slam_msgs__msg__MapGraph(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_slam_msgs__msg__KeyFrame(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = slam_msgs__msg__MapData;
    is_plain =
      (
...
static size_t _MapData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_slam_msgs__msg__MapData(
