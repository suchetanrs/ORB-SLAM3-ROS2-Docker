...
#include "slam_msgs/msg/detail/map_graph__rosidl_typesupport_fastrtps_c.h"
...
using _MapGraph__ros_msg_type = slam_msgs__msg__MapGraph;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: poses_id
  {
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->poses_id, size)) {
      fprintf(stderr, "failed to create array for field 'poses_id'");
      return false;
    }
    auto array_ptr = ros_message->poses_id.data;
...
static uint32_t _MapGraph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_slam_msgs__msg__MapGraph(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = slam_msgs__msg__MapGraph;
    is_plain =
      (
...
static size_t _MapGraph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_slam_msgs__msg__MapGraph(
