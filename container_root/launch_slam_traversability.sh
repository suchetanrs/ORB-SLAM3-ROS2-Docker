...
tmux send-keys -t 2 "cd /root/trav_ws/ && colcon build --symlink-install && source install/setup.bash && cd /home/orb/ORB_SLAM3/ && ./build.sh && source install/setup.bash && cd /root/colcon_ws/ && colcon build --symlink-install" C-m
