...
tmux send-keys -t 2 "cd /home/traversability/traversability_mapping/ && ./build.sh && cd /home/orb/ORB_SLAM3/ && ./build.sh && cd /root/trav_ws/ && colcon build --symlink-install && source install/setup.bash && cd /root/colcon_ws/ && colcon build --symlink-install" C-m
