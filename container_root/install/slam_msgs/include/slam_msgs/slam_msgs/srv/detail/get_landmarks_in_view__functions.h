...
#ifndef SLAM_MSGS__SRV__DETAIL__GET_LANDMARKS_IN_VIEW__FUNCTIONS_H_
#define SLAM_MSGS__SRV__DETAIL__GET_LANDMARKS_IN_VIEW__FUNCTIONS_H_
...
/// Initialize srv/GetLandmarksInView message.
/**
...
/// Finalize srv/GetLandmarksInView message.
/**
...
/// Create srv/GetLandmarksInView message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * slam_msgs__srv__GetLandmarksInView_Request__init().
...
/// Destroy srv/GetLandmarksInView message.
/**
 * It calls
 * slam_msgs__srv__GetLandmarksInView_Request__fini()
...
/// Copy a srv/GetLandmarksInView message.
/**
...
/// Initialize array of srv/GetLandmarksInView messages.
/**
...
/// Finalize array of srv/GetLandmarksInView messages.
/**
 * It calls
 * slam_msgs__srv__GetLandmarksInView_Request__fini()
...
/// Create array of srv/GetLandmarksInView messages.
/**
 * It allocates the memory for the array and calls
 * slam_msgs__srv__GetLandmarksInView_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetLandmarksInView messages.
/**
 * It calls
 * slam_msgs__srv__GetLandmarksInView_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetLandmarksInView message array equality.
/**
...
/// Copy an array of srv/GetLandmarksInView messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * slam_msgs__srv__GetLandmarksInView_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_slam_msgs
...
/**
 * It calls
 * slam_msgs__srv__GetLandmarksInView_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_slam_msgs
...
/**
 * It allocates the memory for the array and calls
 * slam_msgs__srv__GetLandmarksInView_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_slam_msgs
...
/**
 * It calls
 * slam_msgs__srv__GetLandmarksInView_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SLAM_MSGS__SRV__DETAIL__GET_LANDMARKS_IN_VIEW__FUNCTIONS_H_
