...
: ${AMENT_CURRENT_PREFIX:="/root/install/orb_slam3_ros2_wrapper"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/orb_slam3_ros2_wrapper/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/orb_slam3_ros2_wrapper/environment/path.sh"
